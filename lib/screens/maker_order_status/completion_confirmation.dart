...
class CompletionConfirmation extends StatefulWidget {
  const CompletionConfirmation({Key? key}) : super(key: key);

  @override
  _CompletionConfirmationState createState() => _CompletionConfirmationState();
}

class _CompletionConfirmationState extends State<CompletionConfirmation> {
  // @override
  // void initState() {
